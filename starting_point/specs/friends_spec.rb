...
class TestFriends < MiniTest::Test
 ...
 def test_favourite_tv_show
   result = favourite_tv_show(@person1)
...
#   result = likes_to_eat(@person3, "bread")
...
def test_lend_money
  result = lend_money(@person5, @person4, 50)
  assert_equal(@person5[:monies] == 50, result)
end

def test_lend_money
  result = lend_money(@person5, @person4, 50)
  assert_equal(@person4[:monies] == 70, result)
end
